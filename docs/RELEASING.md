...
5. Scan the exact assets again with `python3 scripts/privacy_audit.py dist/0.4.4/CodexAccountSwitcher-0.4.4-macOS-arm64.zip`. Inspect repository commit authors, messages, and filenames as well.
...
7. For this candidate use a pre-release tag such as `v0.4.4-rc.1`. Do not mark the release stable until real-world acceptance is complete. Download the published assets again and compare SHA256.
